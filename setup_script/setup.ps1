...
$links = @(
    ...
    @{ Name = "komorebi.json"; Target = "..\komorebi\komorebi.json" },
    @{ Name = "applications.json"; Target = "..\applications.json" },
    @{ Name = "komorebi.ahk"; Target = "..\komorebi\komorebi.ahk" },
    @{ Name = "komorebi.bar.json"; Target = "..\komorebi.bar.json" }
)
...
$scheduledTasks = @(
    @{
        Name = "Komorebi Admin Logon";
        XmlPath = "..\task_scheduler\Komorebi_Admin_Logon.xml"
    },
    @{
